...
public class UserMenu extends javax.swing.JFrame {
    ...
    private void listarDepartamentos() {
        ...
        if (filtro.isEmpty()) {
            ...
            String filtroSucursales = "SELECT nombreSucursal, nombreDepartamento, CONCAT('Zona ', zona, '. ', tipoCalle, ' ', numero1,' #No. ', numero2, ' - ', numero3) AS direccion FROM direccion INNER JOIN sucursal ON direccion.idDireccion = sucursal.FK_idDireccion ORDER BY nombreDepartamento;";
    ...
    private void initComponents() {
        ...
        btnAddPuestoTrabajo = new javax.swing.JButton();
        ...
        btnAddPuestoTrabajo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assests/empleado (1).png"))); // NOI18N
        btnAddPuestoTrabajo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddPuestoTrabajoActionPerformed(evt);
            }
        });
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addGap(184, 184, 184)
                .addComponent(btnAddPuestoTrabajo, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void tblEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleadosMouseClicked
        ...
        String nombreSucursal = tblEmpleados.getValueAt(filaSeleccionada, 5).toString();

        // Validamos que si se esten capturando los valores de forma correcta
        String empleadoSelecionado = ", Nombre: " + nombreEmp + ", Apellidos: " + apellidos
                + ", Tipo de documento: " + tipoDocumento + ", Documento" + documento + ", Correo: " + correo + ", nombreSucursal: " + nombreSucursal;
        String empleadoSelecionado2 = nombreSucursal + ". " + nombreEmp + " " + apellidos;
        ...
        showUserForm.recibirDatosDeUserMenu(nombreSucursal,nombreEmp, apellidos, tipoDocumento, documento, correo);
        // Se hace visible
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (departamento.equals("Selecciona_una_opcion") || zona.equals("Selecciona_una_opcion") || tipoCalle.equals("Selecciona_una_opcion") || numero1.isEmpty() || numero2.isEmpty() || numero3.isEmpty()) {
            ...
            try {
                ...
                String queryIdDireccion = "SELECT idDireccion FROM `direccion` WHERE nombreDepartamento = '"
                        + departamento + "' AND zona = '" + zona + "' AND tipoCalle = '" + tipoCalle
    ...
    private void tblDepartamentosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDepartamentosMouseClicked
        int numeroFila = tblDepartamentos.getSelectedRow();
        String sucursal = tblDepartamentos.getValueAt(numeroFila, 0).toString();
        String departamento = tblDepartamentos.getValueAt(numeroFila, 1).toString();
    ...
    private void btnAddPuestoTrabajoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPuestoTrabajoActionPerformed
    ...
    }//GEN-LAST:event_btnAddPuestoTrabajoActionPerformed
    ...
    private javax.swing.JButton btnAddPuestoTrabajo;
